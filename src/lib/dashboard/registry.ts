...
export const ZONES: ZoneDef[] = [
  ...
  { key: 'C1b', view: 'trainer', order: 15, title: "Today's tasks",
    quiet: 'no tasks for today', to: '/app/calendar?view=day',
    hint: "The day's tasks — farrier, vet, to-dos — timed and untimed." },
