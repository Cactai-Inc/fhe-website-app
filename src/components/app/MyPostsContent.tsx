...
import { Pencil, Trash2, Check, X, Globe, Lock } from 'lucide-react';
import {
...
/**
 * MY POSTS — the shared subject content (TASK-ACCOUNTSURFACE §1/§3), rendered
 * by both /app/my-posts and the Account page's inline panel. Moved out of
 * MyPosts.tsx unchanged; the page keeps its own header (incl. the PLUSPASS
 * "+ Post" control, which this task leaves page-only — Orders/Gifts never
 * got one either, and it wasn't asked for here).
 */
