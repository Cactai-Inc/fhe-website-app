...
export function DataTable<T>({
  ...
  // FRAMESCROLL: the table's own min-content width can exceed this frame
  // (root cause of the sideways-page bug — see DataTable's task report). The
  // wrapper below is the scroll container that contains it. tabIndex/role are
  // only set when a table actually overflows, so the other call sites where
  // it never does don't pick up a dead tab stop.
