 ...
 *  Owner ruling 2026-08-10 (TASK-ROSTER): the Clients page (/app/admin) won —
 *  it now shows every contact, so this page's population moved there. While
 *  true: the /app/ops/contacts route redirects to /app/admin and the nav item
 *  is hidden. DirectoryPage and LeadsPage below are NOT retired. */
