-- contract_document_detail returns the cascade field-definition columns so the
-- renderer can display the living-document tree (parent/input_kind/options/etc).
