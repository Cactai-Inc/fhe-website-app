-- attach_horse_to_document now maps the 5 seller-disclosure history fields
-- (training/competition/medical/behavioral/medication) that were seeded then left blank.
