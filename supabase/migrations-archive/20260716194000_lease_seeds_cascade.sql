-- start_lease_contract now seeds the cascading field tree onto each new lease.
...
BEGIN
  ...
  -- The responsible party authors the deal terms ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ they are the originator.
  ...
  v_n := seed_contract_fields(v_doc, jsonb_build_array(
    ...
    -- ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Operational scheduling terms (drive the leased-horse calendar) ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ
    jsonb_build_object('field_key','TXN.PAYMENT_OPTIONS','label','Payment Options (one per line: amount ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ describe)','section','Payment','owner_role','DEAL','value_type','longtext','sort_order',415),
    ...
    jsonb_build_object('field_key','TXN.LESSONS_BEGINNER','label','Lessons/Day ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Beginner','section','Scheduling & Availability','owner_role','DEAL','value_type','number','sort_order',820),
    jsonb_build_object('field_key','TXN.LESSONS_INTERMEDIATE','label','Lessons/Day ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Intermediate','section','Scheduling & Availability','owner_role','DEAL','value_type','number','sort_order',830),
    jsonb_build_object('field_key','TXN.LESSONS_ADVANCED','label','Lessons/Day ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Advanced','section','Scheduling & Availability','owner_role','DEAL','value_type','number','sort_order',840),
    ...
    -- ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Owner-only permissions (lessor's sole discretion) ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ
