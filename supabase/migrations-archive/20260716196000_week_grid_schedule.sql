-- seed_contract_fields maps the scheduling fields (DAYS_USED/RESERVED_DAYS/
-- DAYS_UNAVAILABLE) to input_kind='week_grid' for the weekly grid control.
...
UPDATE contract_fields SET input_kind='week_grid' WHERE field_key IN ('TXN.DAYS_USED','TXN.RESERVED_DAYS','TXN.DAYS_UNAVAILABLE');
