-- A8B: the party-side and staff-side Send/Resend-a-copy UI needs to know
-- whether the executed-copy email already went out
-- (documents.executed_email_sent_at, added in 20260804050000) to label its
-- button "Send" vs "Resend". Neither read model exposed the column yet.

-- RETURNS TABLE grows a column: CREATE OR REPLACE cannot change a function's
