-- Expose sent_at / archived_at / cancelled_at on contract_document_detail so
-- the contract page can show status and gate the send/cancel/archive/delete actions.
