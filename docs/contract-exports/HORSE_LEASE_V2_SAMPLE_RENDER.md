...
Generated 2026-07-27 from the LIVE template in a rolled-back transaction — nothing
was saved to the database. All lessor/horse/vendor details are fictional; FHE is
the Lessee (the real first-contract posture). Configuration: partial lease, all
...
Lessee shall have an evaluation period of 2 weeks beginning on the date this Agreement is fully signed by both parties, during which time either party may terminate the Agreement and all payments must be returned upon notification of termination.
