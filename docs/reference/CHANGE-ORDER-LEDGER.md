...
**🔒 SCOPE RULING (owner, 2026-09-01, to DISCO-SIGNFLOW, verbatim):**
...
action elements, icons and text go green. See `docs/reports/DISCO-SIGNFLOW-HANDOFF.md` for the inventory
