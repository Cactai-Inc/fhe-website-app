...
> for reading purposes. This is a rendering of the `HORSE_LEASE_SIMPLE` template as it currently
> stands, produced so the keep/cut decisions can be made from the prose rather than from a database.

**Configuration used:** Partial lease · individual Lessor · individual Lessee · Lessor carries general-liability, mortality and medical insurance and bears all deductibles · permitted activities: riding lessons, solo and group arena riding, trail riding.

**How to read this document**

* Every clause is numbered `§section.clause` — for example **§13.26**. The worksheet uses the same numbers.
* All **144** clauses appear, in document order, whether or not they print in the configuration above.
* Clauses that **would not print** in this configuration are shown indented and marked
  `— DOES NOT PRINT HERE —` with the condition that would bring them in. They are still shown in full
  so nothing is decided about a clause without reading it.
* `⟨not collected in this configuration⟩` marks a token whose field is switched off by the answers above.
* Composite inputs (fee schedule, medication schedule, week grid, location, contact list) are shown as
  plain text. The application draws them as small tables; the words are the same, the layout is not.
...
This Horse Lease Agreement (the "Agreement") is made effective as of September 1, 2026 by and between Marguerite Dubois of 14820 El Camino Real, Rancho Santa Fe, CA 92067 ("Lessor") and Anna Whitfield of 2317 Cordoba Court, Encinitas, CA 92024 ("Lessee").
...
> **§2.1**
>
> *— DOES NOT PRINT HERE — prints only when “Lessor is an” is left blank.*
>
...
> **§2.3**
>
> *— DOES NOT PRINT HERE — prints only when “Lessor is an” is “Entity / organization”.*
>
...
> **§2.4**
>
> *— DOES NOT PRINT HERE — prints only when “Lessee is an” is left blank.*
>
...
> **§2.6**
>
> *— DOES NOT PRINT HERE — prints only when “Lessee is an” is “Entity / organization”.*
>
...
This Agreement applies to the following horse (the "Horse"): Bellefleur du Vent
Color: Bay
Markings: Star and snip; left hind sock
Breed: Warmblood
Registration Number: WB-4471902
Sex: Mare
Foaling date: April 12, 2015
Current fair market value: $45,000
Microchip: 985141000123456
Passport: FEI 104XY22
...
Co-owners: None — Lessor is sole owner
...
> **§3.5**
>
> *— DOES NOT PRINT HERE — prints only when “Any limitations on ownership?” is “YES”.*
>
> Ownership related leasing restrictions: ⟨blank⟩
...
> **§3.7**
>
> *— DOES NOT PRINT HERE — prints only when “Any exceptions to note?” is “YES”.*
>
> The Lessor notes the following known exceptions to the behavior of the Horse: ⟨blank⟩
...
> *— DOES NOT PRINT HERE — prints only when “Any exceptions to note?” is “YES”.*
>
> The Lessor notes the following known exceptions to the physical condition of the Horse: ⟨blank⟩

> **§3.10** — Serious Injury History
>
> *— DOES NOT PRINT HERE — prints only when “Has anyone been seriously injured by the Horse's direct actions?” is left blank.*
>
> [This section is completed by the Lessor's selection above. The applicable statement replaces this placeholder once the selection is made; signing is blocked until then.]

**§3.11** — No Serious Injury History
...
> **§3.12** — Serious Injury History Disclosed
>
> *— DOES NOT PRINT HERE — prints only when “Has anyone been seriously injured by the Horse's direct actions?” is “Yes”.*
>
> Lessor discloses that one or more persons have suffered serious injury involving the direct actions of the Horse, as follows, including for each incident the approximate date, the circumstances, the Horse's actions, and the nature of the injury: ⟨not collected in this configuration⟩. Lessee acknowledges this disclosure and proceeds with knowledge of it.

**§3.13** — Pre-Lease Veterinary Examination

Pre-lease veterinary examination of the Horse: Lessee requested at their own expense

**§3.14** — Pre-Lease Trainer Evaluation
...
French Heritage Equestrian, 14820 El Camino Real, Rancho Santa Fe, CA 92067

**§3.16**

*(no printed text — this clause carries only the question “Horse will move to a new location for the Lessee”)*

> **§3.17**
>
> *— DOES NOT PRINT HERE — prints only when “Horse will move to a new location for the Lessee” is “YES”.*
>
> Location during lease term: ⟨blank⟩
...
>
> *— DOES NOT PRINT HERE — prints only when “Purpose of the lease” is left blank.*
>
...
Reserved days of use: Tuesday, Thursday, Saturday

**§5.2**

Additional or custom schedule terms: Saturday use ends at 2:00 p.m. on days Lessor has a scheduled clinic.
...
$650.00 per month, payable in advance on the 1st day of each month
...
> **§8.2**
>
> *— DOES NOT PRINT HERE — prints only when “Accepted payment methods” includes “Credit Card”.*
>
> Credit card payments are processed as follows: ⟨blank⟩

**§8.3** — Payments by the Lessor
...
*(no printed text — this clause carries only the questions “Evaluation period”, “Evaluation period”)*

**§9.2** — Evaluation Period Details

Lessee shall have an evaluation period of 2 weeks beginning on the date this Agreement is fully signed by both parties. The evaluation period fee is included at no separate charge, is earned upon commencement of the evaluation period, and is nonrefundable. Either party may terminate this Agreement during the evaluation period by written notice to the other party. Upon such termination, any per-use or lease fees for usage that occurred remain due, and neither party owes the other any further amount under this Agreement except amounts already accrued.

> **§9.3** — Evaluation Period Details
>
> *— DOES NOT PRINT HERE — prints only when “Evaluation period” is “Requested by Lessee” or “Required by Lessor” and “Evaluation period” is “Fixed evaluation period before the term” and “Length” is 1 or more.*
>
> Lessee shall have an evaluation period of ⟨not collected in this configuration⟩ ⟨not collected in this configuration⟩ beginning on the date this Agreement is fully signed by both parties. The evaluation period fee is ⟨blank⟩, is earned upon commencement of the evaluation period, and is nonrefundable. Either party may terminate this Agreement during the evaluation period by written notice to the other party. Upon such termination, any per-use or lease fees for usage that occurred remain due, and neither party owes the other any further amount under this Agreement except amounts already accrued.

> **§9.4**
>
> *— DOES NOT PRINT HERE — prints only when “Evaluation period” is “Refused by Lessor”.*
>
...
> **§9.5**
>
> *— DOES NOT PRINT HERE — prints only when “Evaluation period” is “Waived by Lessee”.*
>
...
This Agreement continues until August 31, 2027

> **§10.3** — Renewal Terms
>
> *— DOES NOT PRINT HERE — prints only when “Include renewal terms” is “YES”.*
>
> Renewal terms: ⟨blank⟩
...
Lessor grants Lessee the right to use the Horse for the following purpose(s): Riding Lessons, Solo Arena Riding, Group Arena Riding, Trail Riding
...
> **§11.3** — Lessons
>
> *— DOES NOT PRINT HERE — prints only when “Lessee is an” is left blank and “Permitted activities” includes “Riding Lessons”.*
>
...
**§11.4** — Lessons — Continuous Enrollment

Lessee is required to maintain continuous enrollment in weekly riding lessons: Yes.
Lessons shall be conducted only by a French Heritage Equestrian Approved Instructor.

> **§11.5** — Lessons — Lessee's Instruction Program
>
> *— DOES NOT PRINT HERE — prints only when “Lessee is an” is “Entity / organization” and “Permitted activities” includes “Riding Lessons”.*
>
> Lessee is permitted by Lessor to provide riding lessons with the Horse: ⟨blank⟩

> **§11.6** — Training
>
> *— DOES NOT PRINT HERE — prints only when “Permitted activities” includes “Training”.*
>
...
> **§11.7** — Competition Costs and Winnings
>
> *— DOES NOT PRINT HERE — prints only when “Permitted activities” includes “Competitions”.*
>
> Expenses of competition (entry fees, transportation, and the like) are: ⟨blank⟩.
> Any prize money or winnings earned in competition shall belong to: ⟨blank⟩

> **§11.8** — Competition Restrictions
>
> *— DOES NOT PRINT HERE — prints only when “Permitted activities” includes “Competitions”.*
>
> ☐ Check this box to include restrictions for competitions

> **§11.9**
>
> *— DOES NOT PRINT HERE — prints only when “Permitted activities” includes “Competitions” and “Check this box to include restrictions for competitions” is “YES”.*
>
> Competitions are restricted as follows: ⟨blank⟩

> **§11.10**
>
> *— DOES NOT PRINT HERE — prints only when “Permitted activities” includes “Competitions” and “Check this box to include restrictions for competitions” is “NO” or left blank.*
>
> Lessor does not restrict competition activity in any way.

> **§11.11** — Jumping Restrictions
>
> *— DOES NOT PRINT HERE — prints only when “Permitted activities” includes “Jumping”.*
>
> ☐ Check this box to include restrictions for jumping

> **§11.12**
>
> *— DOES NOT PRINT HERE — prints only when “Permitted activities” includes “Jumping” and “Check this box to include restrictions for jumping” is “YES”.*
>
> Jumping is restricted as follows: maximum height ⟨blank⟩; no more than ⟨blank⟩ days per week; under trainer supervision only: ⟨blank⟩

> **§11.13**
>
> *— DOES NOT PRINT HERE — prints only when “Permitted activities” includes “Jumping” and “Check this box to include restrictions for jumping” is “NO” or left blank.*
>
> Lessor does not restrict jumping activity in any way.

**§11.14** — Trail-Riding Restrictions

☑ Check this box to include restrictions for trail riding

**§11.15**

Trail riding is restricted as follows: Only in the company of at least one other rider; no solo trail riding.

> **§11.16**
>
> *— DOES NOT PRINT HERE — prints only when “Permitted activities” includes “Trail Riding” and “Check this box to include restrictions for trail riding” is “NO” or left blank.*
>
> Lessor does not restrict trail-riding activity in any way.

**§11.17** — Additional Restrictions

Additional restrictions: None.

> **§11.18** — Other Allowed Activities
>
> *— DOES NOT PRINT HERE — prints only when “Additional permitted activities” includes “Breeding” or “Emotional Support Services” or “Film / Television / Advertising” or “Other”.*
>
> Lessee is permitted to engage in the following additional activities with the Horse: None — no additional activities

**§11.19** — Other Allowed Activities

Lessee is not permitted to engage in any activities with the Horse beyond the permitted uses stated above.

> **§11.20**
>
> *— DOES NOT PRINT HERE — prints only when “Additional permitted activities” includes “Other”.*
>
> Other additional permitted activity: ⟨not collected in this configuration⟩

**§11.21** — Allowing Others to Ride

The following additional persons may ride or handle the Horse without Lessor's prior permission: The trainer/instructor.
Only the persons identified above shall be permitted to ride or handle the Horse without Lessor's written permission.

> **§11.22**
>
> *— DOES NOT PRINT HERE — prints only when “Others allowed to ride” includes “Other”.*
>
> Other persons allowed to ride or handle the Horse: ⟨not collected in this configuration⟩

**§11.23** — Releases Required for Authorized Riders
...
**§12.1** — Lessee's Responsibility for Care and Exercise
...
>
> *— DOES NOT PRINT HERE — prints only when “Include 3rd party exercise” is “YES”.*
>
...
> Party responsible for arranging: ⟨not collected in this configuration⟩
> Party responsible for costs: ⟨not collected in this configuration⟩
> Lessee's share of the cost: ⟨not collected in this configuration⟩
...
Daily joint supplement, a.m. feed — provided by Lessor

**§12.5** — Farrier Care

Party responsible for arranging: Lessor
Party responsible for costs: Lessor
Farrier: ⟨not collected in this configuration⟩
Farrier phone: ⟨not collected in this configuration⟩

**§12.6** — Veterinary Care

Party responsible for arranging: Lessor
Party responsible for costs: Lessor
Veterinarian: ⟨not collected in this configuration⟩
Practice: ⟨not collected in this configuration⟩
Address: ⟨not collected in this configuration⟩
Veterinarian phone: ⟨not collected in this configuration⟩
...
Lessor will provide the following equipment for the Horse: Front boots / wraps
...
Draw reins, martingales of any kind, and any bit other than the fitted French-link snaffle.
...
> **§12.11**
>
> *— DOES NOT PRINT HERE — prints only when “Prohibited rider aids” includes “Other”.*
>
> Other prohibited rider aid: ⟨blank⟩
...
*(no printed text — this clause carries only the question “General liability insurance is not required for or by either party under this Agreement.”)*
...
> **§13.5**
>
> *— DOES NOT PRINT HERE — prints only when “General liability insurance is not required for or by either party under this Agreement.” is “NO” or left blank and “Deductible responsibility (Lessee-responsibility claims)” is “Split” and “Lessor” is “Has and will maintain” or “Will obtain and will maintain”; or “Lessee” is “Has and will maintain” or “Will obtain and will maintain”.*
>
> The deductible shall be split between the parties: ⟨not collected in this configuration⟩ paid by Lessor and ⟨not collected in this configuration⟩ paid by Lessee.

> **§13.6**
>
> *— DOES NOT PRINT HERE — prints only when “General liability insurance is not required for or by either party under this Agreement.” is “YES”.*
>
...
> **§13.7** — General Liability — Lessee Responsibility
>
> *— DOES NOT PRINT HERE — prints only when “The Lessee accepts financial responsibility for general liability insurance under this Agreement.” is “YES”.*
>
...
**§13.8** — Mortality Insurance

*(no printed text — this clause carries only the question “Mortality insurance is not required for or by either party under this Agreement.”)*
...
> **§13.11**
>
> *— DOES NOT PRINT HERE — prints only when “Mortality insurance is not required for or by either party under this Agreement.” is “NO” or left blank and “Deductible responsibility” is “Split” and “Lessor” is “Has and will maintain” or “Will obtain and will maintain”; or “Lessee” is “Has and will maintain” or “Will obtain and will maintain”.*
>
> The deductible shall be split between the parties: ⟨not collected in this configuration⟩ paid by Lessor and ⟨not collected in this configuration⟩ paid by Lessee.

> **§13.12**
>
> *— DOES NOT PRINT HERE — prints only when “Mortality insurance is not required for or by either party under this Agreement.” is “YES”.*
>
...
> **§13.13** — Mortality — Lessee Responsibility
>
> *— DOES NOT PRINT HERE — prints only when “The Lessee accepts financial responsibility for mortality insurance under this Agreement.” is “YES”.*
>
...
**§13.14** — Medical Insurance

*(no printed text — this clause carries only the question “Medical insurance is not required for or by either party under this Agreement.”)*

> **§13.15**
>
> *— DOES NOT PRINT HERE — prints only when “Medical insurance is not required for or by either party under this Agreement.” is “YES”.*
>
...
> **§13.16** — Medical — Lessee Responsibility
>
> *— DOES NOT PRINT HERE — prints only when “The Lessee accepts financial responsibility for medical insurance under this Agreement.” is “YES”.*
>
...
> **§13.19**
>
> *— DOES NOT PRINT HERE — prints only when “Medical insurance is not required for or by either party under this Agreement.” is “NO” or left blank and “Deductible responsibility” is “Split” and “Lessor” is “Has and will maintain” or “Will obtain and will maintain”; or “Lessee” is “Has and will maintain” or “Will obtain and will maintain”.*
>
> The deductible shall be split between the parties: ⟨not collected in this configuration⟩ paid by Lessor and ⟨not collected in this configuration⟩ paid by Lessee.
...
**§13.23** — Risk of Loss of or Injury to the Horse
...
**§13.25** — Assumption of Inherent Risks
...
**§13.27** — Release of Liability by Lessor
...
**§13.28** — Required Protective Attire
...
**§13.32** — Shared Arena Riding Risks
...
**§13.33** — Waiver of Unknown Claims
...
Lessee may terminate this Agreement by giving Lessor at least 30 days' prior written notice.

**§14.2** — Owner's Right to Terminate

Lessor may terminate this Agreement by giving Lessee at least 30 days' prior written notice.

**§14.3** — Termination for Cause

Either party may terminate this Agreement for cause (including a material breach that remains uncured) by giving the other party at least 10 days' prior written notice.
...
Name: Anna Whitfield
Address: 2317 Cordoba Court, Encinitas, CA 92024
Phone: (760) 555-0198
Email: a.whitfield@example.com

**§15.3** — Lessor

Name: Marguerite Dubois
Address: 14820 El Camino Real, Rancho Santa Fe, CA 92067
Phone: (858) 555-0142
...
Printed Name: Anna Whitfield
Date: ________________

LESSOR (OWNER)
Signature: __________________________
Printed Name: Marguerite Dubois
Date: ________________
...
> *— DOES NOT PRINT HERE — prints only when “Lessee is an” is “Entity / organization”.*
>
> By: ⟨not collected in this configuration⟩
> Title: ⟨not collected in this configuration⟩
> Signing on behalf of Anna Whitfield
...
> By: ⟨not collected in this configuration⟩
> Title: ⟨not collected in this configuration⟩
> Signing on behalf of Marguerite Dubois


---

*94 of 144 clauses print in this configuration; 50 are shown but suppressed.*
