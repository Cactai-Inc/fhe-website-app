...
> This is the original project README (archived 2026-07-27). It references the deleted
> `src/lib/services.ts`, describes "service tiers" (the tier layer was removed), and its
> schema section lists 2 tables. **Current README is at the repo root.**
