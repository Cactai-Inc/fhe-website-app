...
- 🔒 **D45 (2026-09-03): Fable is never a default.** Seven Fable threads spent 30% of the weekly allowance in 9h. MGMT/DSNR/VRFY/WALKR/builds → Opus · HIGH · ON. SUPPLIES-A is the one owner-named Fable thread. GRANTS and SUPPLIES MGMT copies (Fable, barely started) → stop and re-spawn on Opus from their ledgers.
