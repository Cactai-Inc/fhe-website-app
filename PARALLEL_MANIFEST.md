...
- **Integration base (branch every lane forks from):** `preview`  ← the consolidated single-root baseline; this is the trunk everything forks from and merges back into.
